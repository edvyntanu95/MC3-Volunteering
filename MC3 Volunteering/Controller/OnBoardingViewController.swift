...
class OnBoardingViewController: UIViewController, PaperOnboardingDataSource, PaperOnboardingDelegate {
    ...
    func makePages() -> [OnboardingItemInfo]{
        ...
        let page1 = OnboardingItemInfo.init(informationImage: #imageLiteral(resourceName: "handLove"), title: "", description: "Be kind while there is still time", pageIcon: #imageLiteral(resourceName: "handLove"), color: #colorLiteral(red: 0.002539749956, green: 0.3627195954, blue: 0.6189824939, alpha: 1), titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont: UIFont.init(name: "Helvetica", size: 24)!, descriptionFont: UIFont.init(name: "Helvetica", size: 17)!)
        
        let page2 = OnboardingItemInfo.init(informationImage: #imageLiteral(resourceName: "circleFriends"), title: "", description: "More fun when you do it with your friends", pageIcon: #imageLiteral(resourceName: "circleFriends"), color: #colorLiteral(red: 0.002539749956, green: 0.3627195954, blue: 0.6189824939, alpha: 1), titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont: UIFont.init(name: "Helvetica", size: 24)!, descriptionFont: UIFont.init(name: "Helvetica", size: 17)!)
        
        let page3 = OnboardingItemInfo.init(informationImage: #imageLiteral(resourceName: "disabledIcon"), title: "", description: "Let's volunteer", pageIcon: #imageLiteral(resourceName: "disabledIcon"), color: #colorLiteral(red: 0.002539749956, green: 0.3627195954, blue: 0.6189824939, alpha: 1), titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont: UIFont.init(name: "Helvetica", size: 24)!, descriptionFont: UIFont.init(name: "Helvetica", size: 17)!)
